...
public class RestTicket {
	...
	public RestTicket(int id, String reporter, String topic, String description, Type type, Priority priority) {
		super();
		this.id = id;
	...
	@Override
	public Object clone() {
		return new RestTicket(this.id, this.reporter, this.topic, this.description, this.type, this.priority, this.status);
	}
	...
	public static RestTicket toTicket(String content) {
		int id;
		String reporter;
		String topic;
		String description;
		...
		RestTicket newTicket = new RestTicket(id, reporter, topic, description, type, priority,status);
